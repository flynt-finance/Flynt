...
export default function LiquidityTerminal({
	...
	return (
		<motion.div
			...
			className="relative min-h-96 h-full overflow-hidden rounded-2xl border border-slate-100 dark:border-white/10 dark:bg-[#0D1131] bg-bg-secondary p-8"
		>
					...
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-[9px] font-mono text-emerald-500 uppercase">
								Live Node Sync: {connectedBanks.map((b) => b.name).join(" • ")}
							</p>
						</div>
					</div>
